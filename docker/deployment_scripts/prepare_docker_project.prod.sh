...
mv $root_directory/docker/pirri/tmp/pifsc-resource-inventory/RIA/application_code/functions/app_instance_config.prod.php $root_directory/docker/pirri/tmp/pifsc-resource-inventory/RIA/application_code/functions/app_instance_config.php
...
rm $root_directory/docker/pirri/tmp/pifsc-resource-inventory/RIA/application_code/functions/app_instance_config.test.php


#rename the httpd.prod.conf to httpd.conf so it can be used as the active configuration file
mv $root_directory/docker/pirri/tmp/pifsc-resource-inventory/docker/config/httpd.prod.conf $root_directory/docker/pirri/tmp/pifsc-resource-inventory/docker/config/httpd.conf

#rename the php81-php.prod.conf to php81-php.conf so it can be used as the active configuration file
mv $root_directory/docker/pirri/tmp/pifsc-resource-inventory/docker/config/php81-php.prod.conf $root_directory/docker/pirri/tmp/pifsc-resource-inventory/docker/config/php81-php.conf

#rename the php.prod.ini to php.ini so it can be used as the active PHP configuration file
mv $root_directory/docker/pirri/tmp/pifsc-resource-inventory/docker/config/php.prod.ini $root_directory/docker/pirri/tmp/pifsc-resource-inventory/docker/config/php.ini



echo "configure docker files"
cp $root_directory/docker/pirri/tmp/pifsc-resource-inventory/docker/config/docker-compose.prod.prod.yml $root_directory/docker/pirri/tmp/docker-compose.prod.yml
cp $root_directory/docker/pirri/tmp/pifsc-resource-inventory/docker/config/docker-compose.prod.yml $root_directory/docker/pirri/tmp/docker-compose.yml
cp $root_directory/docker/pirri/tmp/pifsc-resource-inventory/docker/config/Dockerfile.prod $root_directory/docker/pirri/tmp/Dockerfile
