...
echo "copy the parr-tools ODS directory"
# copy the parr-tools ODS directory
...
cp -r $root_directory/docker/pirridev/tmp/parr-tools/ODS/SQL/export_queries/*  $root_directory/docker/pirridev/backend/SQL
cp -r $root_directory/docker/pirridev/tmp/parr-tools/ODS/source_data/*  $root_directory/docker/pirridev/backend/source_data
cp -r $root_directory/docker/pirridev/tmp/parr-tools/ODS/application_code/functions/*  $root_directory/docker/pirridev/backend/includes
cp $root_directory/docker/pirridev/tmp/pifsc-resource-inventory/docker/config/generate_ods_data.sh  $root_directory/docker/pirridev/backend/scripts

# copy configuration files:
cp $root_directory/docker/pirridev/tmp/pifsc-resource-inventory/docker/config/ods_crontab.txt  $root_directory/docker/pirridev/backend/config
...
cp $root_directory/docker/pirridev/tmp/pifsc-resource-inventory/docker/config/sqlnet.ora  $root_directory/docker/pirridev/backend/config
