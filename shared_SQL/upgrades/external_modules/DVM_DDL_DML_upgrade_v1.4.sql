...
INSERT INTO DB_UPGRADE_LOGS (UPGRADE_APP_NAME, UPGRADE_VERSION, UPGRADE_DATE, UPGRADE_DESC) VALUES ('Data Validation Module', '1.4', TO_DATE('14-JUN-22', 'DD-MON-YY'), 'Updated the DVM_PKG package to comment out all non-error logging statements to reduce the amount of logging messages.  Updated all DB_LOG_PKG.ADD_LOG_ENTRY procedure calls to use the version of the procedure with no return code parameter.');
