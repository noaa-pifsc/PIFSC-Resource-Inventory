...
INSERT INTO DB_UPGRADE_LOGS (UPGRADE_APP_NAME, UPGRADE_VERSION, UPGRADE_DATE, UPGRADE_DESC) VALUES ('PIFSC Resource Inventory', '0.3', TO_DATE('17-MAY-22', 'DD-MON-YY'), 'Updated PRI_PROJ_RES to add the RES_DESC and RES_DEMO_URL fields; updated the RES_URL to be a longer string data type and allowed.  Updated PRI_RES_V, PRI_PROJ_V, and PRI_RES_PROJ_TAG_MAX_V to add the new PRI_PROJ_RES fields.  Updated PRI_PROJ_RES_TAG_MAX_SUM_V to add in BR-delimited and BR-delimited formatted link fields.  Created PRI_PROJ_RES_TAG_MAX_SUM_ALL_V to add the detailed project information for each project.  Updated PRI_RES_PROJ_TAG_MAX_SUM_V to add in BR-delimited and BR-delimited formatted link fields for the associated projects of each resource.  Created PRI_RES_PROJ_TAG_MAX_SUM_ALL_V to add the detailed resource information for each resource.');
