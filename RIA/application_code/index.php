...
//	echo $resource->add_message("page request to ".$_SERVER["SCRIPT_FILENAME"]." from IP address: ".$_SERVER['REMOTE_ADDR']." with arguments: ".var_export($_REQUEST, true), 3);
  ...
  $css_include = array("./res/css/template.css", "./res/css/tooltip.css", "./res/css/index.css", "./res/css/ajax_load.css", SHARED_LIBRARY_CLIENT_PATH."css/smoothness/jquery-ui.min.css", SHARED_LIBRARY_CLIENT_PATH."css/smoothness/jquery-ui.theme.min.css", SHARED_LIBRARY_CLIENT_PATH."css/smoothness/jquery-ui.structure.min.css");

	//define the javascript include files for the initial HTML page content:
	$javascript_include = array(SHARED_LIBRARY_CLIENT_PATH."js/jquery.min.js", SHARED_LIBRARY_CLIENT_PATH."js/jquery-ui.min.js", "./res/js/template.js", "./res/js/index.js", "./res/js/tooltip.js", "./res/js/RIA_tooltips.js");

  //generate the javascript include files with the "defer" keyword
  $priority_header_content = "<link rel=\"icon\" href=\"favicon.ico\" type=\"image/vnd.microsoft.icon\" />";
